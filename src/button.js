  ...
  render() {
    ...
    return (
      <section className="wrapper" style={{width: `calc(${this.props.width*100}% - 1em)`}}>
        ...
        <div style={{...variants[this.variant], ...sizes[this.size], ...color, ...handleDisabled } } className={this.props.style.disableShadow?'btn no-shadow':'btn'} onClick={_=>{console.log(this.props)}} >
